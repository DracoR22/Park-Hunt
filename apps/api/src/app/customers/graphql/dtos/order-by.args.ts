...
import { BookingOrderByRelationAggregateInput } from 'src/app/bookings/graphql/dtos/order-by.args'
...
@InputType()
export class CustomerOrderByWithRelationInput extends PartialType(CustomerOrderByWithRelationInputStrict) {}
