...
import { Customer } from 'src/app/customers/graphql/entity/customer.entity'
import { ValetAssignment } from 'src/app/valet-assignments/graphql/entity/valet-assignment.entity'
import { AggregateCountOutput } from 'src/common/dtos/common.input'
import { BookingWhereInput } from './dtos/where.args'
import { BookingTimeline } from 'src/app/booking-timelines/graphql/entity/booking-timeline.entity'
...
export class BookingsResolver {
  ...
  async bookingsForValet(@Args() args: FindManyBookingArgs, @GetUser() user: GetUserType) {
  ...
  bookingsForCustomer(@Args() args: FindManyBookingArgs, @GetUser() user: GetUserType) {
    return this.bookingsService.findAll({
      ...args,
  ...
  async bookingsForGarage(
    @Args() { cursor, distinct, orderBy, skip, take, where }: FindManyBookingArgs,
