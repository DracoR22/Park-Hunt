...
export type LoginMutation = {
  ...
  login: {
    __typename?: 'LoginOutput'
    token: string
    user: { __typename?: 'User'; uid: string; name?: string | null; image?: string | null }
  }
}
...
export type GetAuthProviderQuery = {
  __typename?: 'Query'
  getAuthProvider?: { __typename?: 'AuthProvider'; uid: string; type: AuthProviderType } | null
}
...
export type SearchGaragesQuery = {
  ...
  searchGarages: Array<{
    ...
    address?: { __typename?: 'Address'; lat: number; lng: number; address: string } | null
    availableSlots: Array<{ __typename?: 'MinimalSlotGroupBy'; type: SlotType; pricePerHour: number; count: number }>
      ...
      variableDefinitions: [
        {
          ...
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'registerWithCredentialsInput' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'RegisterWithCredentialsInput' } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<RegisterWithCredentialsMutation, RegisterWithCredentialsMutationVariables>
...
} as unknown as DocumentNode<GetAuthProviderQuery, GetAuthProviderQueryVariables>
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'registerWithProviderInput' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'RegisterWithProviderInput' } },
          },
        },
      ],
      selectionSet: {
            ...
            arguments: [
              {
                ...
                value: { kind: 'Variable', name: { kind: 'Name', value: 'registerWithProviderInput' } },
              },
            ],
            selectionSet: {
              kind: 'SelectionSet',
...
} as unknown as DocumentNode<RegisterWithProviderMutation, RegisterWithProviderMutationVariables>
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'createGarageInput' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'CreateGarageInput' } },
          },
        },
      ],
      selectionSet: {
            ...
            arguments: [
              {
                ...
                value: { kind: 'Variable', name: { kind: 'Name', value: 'createGarageInput' } },
              },
            ],
            selectionSet: {
              kind: 'SelectionSet',
...
} as unknown as DocumentNode<CreateGarageMutation, CreateGarageMutationVariables>
      ...
      variableDefinitions: [
        {
          ...
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'DateFilterInput' } } },
        },
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'locationFilter' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'LocationFilterInput' } },
          },
        },
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'slotsFilter' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'SlotWhereInput' } },
        },
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'garageFilter' } },
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              },
              {
                ...
                value: { kind: 'Variable', name: { kind: 'Name', value: 'locationFilter' } },
              },
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'slotsFilter' },
                value: { kind: 'Variable', name: { kind: 'Name', value: 'slotsFilter' } },
              },
              {
                kind: 'Argument',
