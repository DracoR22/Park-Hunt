import { Dialog as HeadlessUIDialog, DialogPanel, DialogTitle, Transition, TransitionChild } from '@headlessui/react'
...
export const Dialog = ({ open, setOpen, children, title, widthClassName = 'max-w-md' }: IMyDialogProps) => {
  function closeModal() {
    setOpen(false)
  }
  ...
  return (
    <Transition appear show={open} as={Fragment}>
      <HeadlessUIDialog as="div" className="relative z-50 rounded" onClose={closeModal}>
        <TransitionChild
          as={Fragment}
