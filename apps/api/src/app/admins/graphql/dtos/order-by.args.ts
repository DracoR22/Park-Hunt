...
import { VerificationOrderByRelationAggregateInput } from 'src/app/verifications/graphql/dtos/order-by.args'
...
@InputType()
export class AdminOrderByWithRelationInput extends PartialType(AdminOrderByWithRelationInputStrict) {}
