...
import { AdminRelationFilter } from 'src/app/admins/graphql/dtos/where.args'
import { GarageRelationFilter } from 'src/app/garages/graphql/dtos/where.args'
...
export class VerificationWhereInputStrict
  implements RestrictProperties<VerificationWhereInputStrict, Prisma.VerificationWhereInput>
{
...
@InputType()
export class VerificationWhereInput extends PartialType(VerificationWhereInputStrict) {}
