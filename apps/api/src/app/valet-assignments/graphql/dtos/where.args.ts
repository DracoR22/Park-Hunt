...
import { BookingRelationFilter } from 'src/app/bookings/graphql/dtos/where.args'
...
export class ValetAssignmentWhereInputStrict
  implements RestrictProperties<ValetAssignmentWhereInputStrict, Prisma.ValetAssignmentWhereInput>
{
  bookingId: IntFilter
...
@InputType()
export class ValetAssignmentWhereInput extends PartialType(ValetAssignmentWhereInputStrict) {}
